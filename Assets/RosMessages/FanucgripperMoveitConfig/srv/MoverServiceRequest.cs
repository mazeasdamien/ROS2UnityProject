...
namespace RosMessageTypes.FanucgripperMoveitConfig
{
    ...
    {
        public const string k_RosMessageName = "fanucgripper_moveit_config/MoverService";
        public override string RosMessageName => k_RosMessageName;

        public FanucMoveitJointsMsg joints_input;
        public Geometry.PoseMsg pick_pose;
        public Geometry.PoseMsg place_pose;

        public MoverServiceRequest()
        {
            this.joints_input = new FanucMoveitJointsMsg();
            this.pick_pose = new Geometry.PoseMsg();
            this.place_pose = new Geometry.PoseMsg();
        }

        public MoverServiceRequest(FanucMoveitJointsMsg joints_input, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
        ...
        {
            this.joints_input = FanucMoveitJointsMsg.Deserialize(deserializer);
